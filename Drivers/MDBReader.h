...
extern void ReaderDevProcess(uint32_t *RecvMoney,uint8_t cmdOpt,uint16_t  ReaderPrice, uint8_t *readerStatus);

extern uint8_t ReaderDevInit(void);

extern void ReaderDevDisable(void);

extern void ReaderDevEnable(void);

extern void ReaderSessionVendRequest(uint16_t ItemPrice);

extern void ReaderSessionVendSuccess(void);

extern void ReaderSessionVendFail(void);
